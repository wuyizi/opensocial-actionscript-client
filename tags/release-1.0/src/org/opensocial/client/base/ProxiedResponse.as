...
public class ProxiedResponse extends BaseType {
   ...
   * NOTE: this change for myspace, when myspace's makeRequest function has error. the return object exist 'errorCode' prop.
   * @param obj The response object returned from proxy.
   */
  public function ProxiedResponse(obj:* = null) {
    obj_ = obj;
    if (obj_['errorCode']) {
      obj_['errors'] = [obj_['errorCode']];
      obj_['text'] = obj_['errorMessage'];
    } else if (!obj_['errors']) {
      obj_['errors'] = [];
    }
  }
   ...
   * NOTE: this change for myspace, myspace's makeRequest function do not returned 'rc' prop.
